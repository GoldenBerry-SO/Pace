---
name: spec
description: Refine a feature into a tracked epic with ordered sub-issues, each mapping to one PR. Use when user wants to spec a feature, plan a feature, break a feature into issues, or scope a new initiative. Does NOT write code — hand off to `/implement` when ready to build.
