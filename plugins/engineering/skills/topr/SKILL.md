---
name: topr
description: Rebase a stacked PR onto the latest origin/main, correctly dropping commits already merged via squash-and-merge. Use when user wants to refresh a stacked PR after an earlier PR in the stack merged, or says "rebase this PR on main".
